      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {filteredTestimonials.slice(0, 3).map((testimonial) => (
            ...
            >
              {/* Ethiopian Flag Corner */}
              <div className="absolute top-0 right-0 w-16 h-16 overflow-hidden">
                <div className="absolute top-0 right-0 w-16 h-8 bg-green-500"></div>
                <div className="absolute bottom-0 right-0 w-16 h-8 bg-red-500"></div>
        ...
        <div className="mt-20 pt-16 border-t border-gray-200">
          <div className="text-center">
            ...
            {/* Ethiopian Guarantee */}
            <div className="mt-12 inline-flex items-center gap-4 bg-gradient-to-r from-primary-50 to-yellow-50 rounded-2xl px-8 py-6 border border-primary-100 max-w-2xl mx-auto">
              <div className="w-12 h-12 bg-primary-500 rounded-full flex items-center justify-center">
                <Award className="w-6 h-6 text-white" />
              </div>
              <div className="text-left">
                <div className="font-semibold text-gray-900 text-lg">Ethiopian Tourism Excellence Award 2023</div>
                <div className="text-gray-600">Recognized for outstanding cultural preservation and sustainable tourism practices</div>
              </div>
            </div>
          </div>
        </div>
