  ...
  return (
    <div className="flex flex-col group">
      ...
      <div className="flex items-center space-x-2 md:space-x-3">
        ...
        <div className="flex flex-col justify-center h-12 md:h-14 lg:h-16">
          <div className="font-bold">
            <div className="text-blue-800 text-sm">PHOENIX</div>
            <div className="text-yellow-500 text-sm mt-[-0.2rem]">ETHIOPIA</div>
            <div className="text-green-800 text-sm mt-[-0.2rem] flex items-center gap-1">
              TOURS
              <Footprints className="w-5 h-5 text-gray-800" />
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="mt-[-0.4rem]">
        <p className="text-[10px] md:text-[12px] text-blue-800 italic text-center leading-tight">
